...
%DIF DEL second_submission.tex   Wed May 24 12:16:51 2023
%DIF ADD main.tex                Wed May 24 12:05:56 2023
...
The data were retrieved using the Inspire HEP database \citep{InspireAPI}. Inspire HEP is a platform dedicated to the HEP community and is maintained by \DIFdelbegin \DIFdel{members of }\DIFdelend \DIFaddbegin \DIFadd{organizations that include }\DIFaddend CERN, DESY, Fermilab and SLAC. It aggregates publications from the \gls{hep} literature, and maintains a list of institutions and collaborations involved in the community, while also publishing job offers. It replaced Spires in 2012\footnote{``Physicists, start your searches: INSPIRE database now online'', \textit{Symmetry}, May 24th 2012, \url{https://www.symmetrymagazine.org/breaking/2012/05/24/physicists-start-your-searches-inspire-database-now-online}
}.
...
\citealt{Mttig2019,Mttig2020a} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citet{Mttig2019,Mttig2020a} }\hspace{0pt}%DIFAUXCMD
}\DIFaddend -- and developments in these subcultures may become quite orthogonal.

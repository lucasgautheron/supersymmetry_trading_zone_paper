...
\subsubsection{Topics and their correlation with categories}
...
\caption{\label{fig:tsne}Semantic map extracted from the topic model using t-SNE transformation. Each dot represents a topic.}
\end{figure}

Although the t-SNE transformation does not yield very stable results, it appears that: i) topics most associated with each category are generally closer, in other words these three poles explain part of the variance in the semantic space; and ii) the distinction between phenomenological supersymmetry and theoretical supersymmetry appears as two separate clusters of supersymmetry-related topics in this representation.

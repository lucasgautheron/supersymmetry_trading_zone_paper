...
% The decrease in imports of theoretical ideas in phenomenological papers may have a variety of roots. It might be result from a shift in phenomenological practice while theoretical practice itself remained unchanged. Or it could be that theoretical practice shifted in a way unlikely to sustain trades with phenomenologists. In order to verify these two hypotheses it is useful to estimate the likelihood of trades as a function of two variables: the year of publication of the cited papers, and the year of publication of the citing paper.
...
% As one examines trades between two scientific cultures or disciplines, it is important to keep in mind that these are undergoing constant transformations. As a result, that a, say, phenomenological paper (published at a year $y_i$) cites a theoretical paper (published at a year $y_j\leq y_i$) does not establish a connection between these cultures in general but between these cultures as they existed at those specific times. In order to locate trades between subcultures of a field it can thus be useful to examine their intensity as a function of not just the year of publication of the papers citing other work, but also as a function of the papers being cited. The results for trades between the theoretical and phenomenological subcultures are shown in Figure \ref{fig:trading_zone_years}. 
...
%     The upper matrix shows the probability of trades that consist in citations of theoretical papers that originate from phenomenological paper. The lower matrix shows the probability of trades that consist in citations of phenomenological papers originating from theoretical papers.}

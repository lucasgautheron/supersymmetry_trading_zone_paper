...
In order to investigate the plurality of supersymmetry-related research in \gls{hep}, we will use semantic analyses as well. To this end, we will develop a topic model approach in order to identify heterogeneous clusters of concepts that are most likely to be associated with supersymmetry in the literature, and we will explore their dynamics throughout time.

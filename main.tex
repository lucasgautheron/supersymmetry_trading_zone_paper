...
All the data and code used to derive the results of this paper can be accessed from the following repository using the DataLad software \citep{datalad_paper}: \url{https://gin.g-node.org/lucasgautheron/trading_zones_material}. A permanent archive of the code is available at the following URL: \url{https://doi.org/10.12751/g-node.6yjfc5}. 
